 ...
 */
void flash_range_erase(uint32_t flash_offs, size_t count, bool enable_xip);
...
void flash_range_program(uint32_t flash_offs, const uint8_t *data, size_t count, bool enable_xip);
